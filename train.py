...
from dataset.Univ_1652 import Uni_1652
...
parser.add_argument('--resume', default='D:/Trans_drone/checkpoint', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('--save_path', default='D:/Trans_drone/Save', type=str, metavar='PATH',
...
parser.add_argument('--dataset', default='Uni_1652', type=str,
                    help='vigor, cvusa, cvact, Uni_1652')
...
def compute_complexity(model, args):
    if args.dataset == 'vigor':
        ...
        size_sat = [512, 512]  # [512, 512]
        size_sat_default = [512, 512]  # [512, 512]
        size_drone = [512, 512]  # [224, 1232]
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_scan_dataset = dataset(mode='train', print_bool=True, same_area=(not args.cross), args=args)
    ...
    val_query_loader = torch.utils.data.DataLoader(
        val_query_dataset,batch_size=128, shuffle=False,
        num_workers=args.workers, pin_memory=True) # 512, 64
    
    val_reference_loader = torch.utils.data.DataLoader(
        val_reference_dataset, batch_size=128, shuffle=False,
